...
const queryAddVotesCard = "INSERT INTO VotesCard VALUES (DEFAULT, ?, ?, NULL, NOW(), NULL, TRUE, ?);";//idCard, idAssociate, 
...
function addVotesCard(idCard, idAssociate, idThingsPeopleToEvaluate){
	return new Promise(function (resolve, reject){

    log.info(`idCard = ${idCard}; idAssociate = ${idAssociate}; idThingsPeopleToEvaluate = ${idThingsPeopleToEvaluate}`);

    const client = dbUtil.getMariaClient();
    const params = [idCard, idAssociate, idThingsPeopleToEvaluate];
